...
gst-launch-1.0 -v v4l2src device=/dev/$DEVICE io-mode=dmabuf ! video/x-raw,width=$WIDTH,height=$HEIGHT,format=NV12,framerate=30/1 ! videoconvert ! clutterautovideosink
