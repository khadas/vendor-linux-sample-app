...
CMD="gst-launch-1.0 -v v4l2src device=/dev/$DEVICE $USE_FRAME_CNT ! video/x-raw,width=$SRC_WIDTH,height=$SRC_HEIGHT,format=$SRC_FORMAT ! videoconvert ! $SINK"
echo $CMD
